  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
      ...
      .authorizeRequests()
            ...
            .antMatchers(HttpMethod.POST, "/hotel/saveHotel","/hotel/hotelByUserId/{id}").hasRole("GESTIONNAIRE")
            .antMatchers(HttpMethod.GET, "/hotel/hotelByUserId/{id}").hasRole("GESTIONNAIRE")
...
//            .antMatchers(HttpMethod.DELETE, "/chamber/deleteChamber/{id}").hasRole("ADMIN")
            .antMatchers("/user/all","/user/allRoles","/user/{id}","/user/userByRole/{role}","/user/deleteUser/{id}").hasRole("ADMIN")
